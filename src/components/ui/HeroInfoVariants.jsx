        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-stretch">
          ...
          <picture className="shrink-0 self-center sm:self-start">
            ...
            <img
              ...
              loading="lazy"
              className="mx-auto block aspect-[3/4] h-72 w-auto max-w-full rounded-sm border border-border object-contain object-center sm:mx-0 sm:aspect-auto sm:h-[102px] sm:w-20 md:h-[122px] md:w-24 lg:h-[164px] lg:w-32"
            />
          </picture>
        </div>
